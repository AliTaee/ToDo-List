describe('Test list Note', () => {
  ...
  describe('Test Create a multi note fot test', () => {
    ...
    for (let index = 1; index <= 5; index++) {
      ...
      it('Should Note have a delete and edit button', () => {
        cy.get('[data-test=note-delete]').should('have.length', index);
        cy.get('[data-test=note-edit]').should('have.length', index);
      });
    }
  });
  ...
  describe('Test Delete some note.', () => {
