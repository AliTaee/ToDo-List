...
function tasksReducer() {
  ...
  switch (action.type) {
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_3__["INITIAL_LOCALSTORAGE"]:
      {
        return Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(action.payload.data.tasksReducer);
      }

    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_3__["ADD_TASK"]:
      {
        var taskWidthData = _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, action.payload.newTask, {
          date: new Date().toISOString().replace('-', '/').split('T')[0].replace('-', '/'),
          id: shortid.generate(),
          done: false
        });

        return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(state), [taskWidthData]);
      }
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_3__["EDIT_TASK"]:
      {
        var editTask = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(state);
    ...
    case _actions_actionTypes__WEBPACK_IMPORTED_MODULE_3__["DONE_TASK"]:
      {
        var doneTask = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(state);
...
//# sourceMappingURL=_app.js.0decd842312a5ff3b006.hot-update.js.map